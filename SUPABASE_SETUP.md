...
- Jalankan `SUPABASE_AUTH_REPAIR.sql` di Supabase SQL Editor. File ini memperbaiki trigger `handle_new_user`, memastikan tabel `user_roles` memiliki kolom yang diperlukan, dan mengisi role yang belum ada.
